          ...
          <div className="animate-slide-in stagger-3" style={{
            ...
            <div className="slide-card" style={{ borderLeft: '4px solid var(--track-2-primary)' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                {[
                  { icon: FileText, title: '3개 비즈니스 트랙', desc: 'IDP(기존) + 접근성/PDF렌더링(신규)', section: '파트 1' },
              ...
              <div style={{
                ...
                <p style={{
                  ...
                  <strong style={{ color: 'var(--track-2-primary)' }}>목적:</strong> 3개 비즈니스 트랙의 시장 분석 및 우선순위 결정, 오픈소스 라이선스 전략 결정을 위한 정보 제공
                </p>
              </div>
            </div>
          </div>
